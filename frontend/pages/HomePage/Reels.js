    ...
    const renderItem = ({ item, index }) => {
        return (
            <View style={[{ flex: 1, height: Dimensions.get('screen').height, width: Dimensions.get('window').width}, index % 2 == 0 ? <ShimmerPlaceholder /> : <ShimmerPlaceholder />]}>
                ...
                <TouchableOpacity style={styles.whatsappBtn} onPress={() => Linking.openURL(`https://wa.me/8929007192?text=Hey sir i would like to discuss about aogglehomes/${item} property.`)}>
